...
public class Pawn extends Piece{
    ...
    public boolean isLegitMove(int x1, int y1, int x2, int y2) {
        ...
        if (colour == PieceColour.BLACK){
            if (tb[x2][y2].hasPiece() == false && y1==y2 && x1==1 && (x2==2 || x2==3)) {
